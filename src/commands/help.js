...
const HELP_PAGES = {
  ...
  pirate: {
    ...
    body: [
      "**Pirate System**",
      `\`${PREFIX} pirate\` — show pirate help menu`,
      `\`${PREFIX} pirate info\` — view your pirate overview`,
      `\`${PREFIX} pirate create <name>\` — create a pirate crew`,
      `\`${PREFIX} pirate storage\` — view pirate storage`,
      `\`${PREFIX} pirate level\` — view pirate level requirement`,
      `\`${PREFIX} pirate perks\` — view global pirate perks`,
      `\`${PREFIX} pirate shop\` — view pirate token shop`,
      `\`${PREFIX} pirate raid\` — view pirate raid bosses`,
      `\`${PREFIX} pirate lb\` — view weekly pirate leaderboard`,
      "",
      "**Notes**",
