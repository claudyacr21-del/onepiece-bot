...
const HELP_PAGES = {
  main: {
    ...
    body: [
      ...
      "`team` | view team",
      "`add <card> <slot>` | add a card to your team",
      "`remove <card>` | remove one card from your team",
  ...
  card: {
    ...
    body: [
      ...
      "",
      "**LevelUp**",
      "`op level frag <count> <card>` → consume card fragments to increase card level",
      "",
      "**Notes**",
  ...
  battle: {
    ...
    body: [
      ...
      "`op add <card> <slot>` → add a card to your team",
      "`op remove <card>` → remove one card from your team",
