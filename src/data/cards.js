...
const SPECIAL_FORMS = {
  ...
  shirahoshi_sea_princess: ["Fish-Man Island Arc", "Reverie Arc", "Ancient Weapon Arc"],
  hiyori_festival_support: ["Wano Country Arc", "Onigashima Arc", "Post-Wano Arc"],
  carina_treasure_hunter: ["Film Gold Arc", "New World Crime Arc", "Underworld Arc"],
  kalifa_cp9_support: ["Water 7 Arc", "Enies Lobby Arc", "CP0 Arc"],
  baccarat_lucky_draw: ["Film Gold Arc", "Underworld Arc", "Luck Manipulation Arc"],
  perona_ghost_princess: ["Thriller Bark Arc", "Sabaody Archipelago Arc", "Hawk Pirates Arc"],
  tsuru_tactical_support: ["Marineford Arc", "Sengoku Era Arc", "Marine HQ Arc"],
  reiju_poison_pink: ["Whole Cake Island Arc", "Germa Kingdom Arc", "Wano Support Arc"],
  otama_kibi_support: ["Wano Country Arc", "Onigashima Arc", "New Era Arc"],
  iceburg: ["Water 7 Arc", "Enies Lobby Arc", "Pluton Era Arc"],
  laboon: ["Reverse Mountain Arc", "Thriller Bark Arc", "Grand Line Eternal Arc"],
  sniper_focus: ["East Blue Training Arc", "Enies Lobby Arc", "God Tier Sniper Arc"],
  weather_science: ["Loguetown Arc", "Grand Line Arc", "Climate Warfare Arc"],
  wado_ichimonji_spirit: ["Zoro Childhood Arc", "Thriller Bark Arc", "Black Blade Awakening Arc"],
  suna_suna_core: ["Alabasta Arc", "Crocodile Arc", "Sand Dominion Arc"],
  ohara_will: ["Ohara Incident Arc", "Robin Flashback Arc", "Void Century Arc"],
  goro_goro_core: ["Skypiea Arc", "Enel Arc", "Lightning God Arc"],
