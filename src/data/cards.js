...
const BASE_CARDS = [
  ...
  // =========================
  battleCard({ id: 1, code: "luffy_straw_hat", name: "Monkey D. Luffy", title: "Straw Hat", rarity: "A", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Base", type: "Captain", atk: 150, hp: 1200, speed: 85, basePower: 2000, weapon: "None", devilFruit: "Hito Hito no Mi, Model: Nika", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 2, code: "zoro_pirate_hunter", name: "Roronoa Zoro", title: "Pirate Hunter", rarity: "A", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Three Sword Style", type: "Attacker", atk: 130, hp: 850, speed: 75, basePower: 1990, weapon: "Wado Ichimonji, Sandai Kitetsu, Enma", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 3, code: "nami_cat_burglar", name: "Nami", title: "Cat Burglar", rarity: "B", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Base", type: "Support", atk: 80, hp: 600, speed: 95, basePower: 1470, weapon: "Basic Staff", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 4, code: "usopp_sniper", name: "Usopp", title: "Sniper", rarity: "B", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Base", type: "Ranged", atk: 85, hp: 620, speed: 88, basePower: 1450, weapon: "Basic Slingshot", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 5, code: "sanji_black_leg", name: "Sanji", title: "Black Leg", rarity: "A", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Base", type: "Speed Fighter", atk: 125, hp: 820, speed: 90, basePower: 1970, weapon: "Black Leg Combat Shoes", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 6, code: "koby_aspiring_marine", name: "Koby", title: "Aspiring Marine", rarity: "B", arc: "East Blue", faction: "Marines", variant: "Early Days", type: "Support", atk: 52, hp: 520, speed: 70, basePower: 1475, weapon: "None", devilFruit: "None", equipType: "None", image: "" }),
  battleCard({ id: 7, code: "alvida_iron_club", name: "Alvida", title: "Iron Club", rarity: "C", arc: "East Blue", faction: "Alvida Pirates", variant: "Base", type: "Bruiser", atk: 68, hp: 740, speed: 42, basePower: 850, weapon: "Basic Iron Club", devilFruit: "Sube Sube no Mi", equipType: "Weapon", image: "" }),
  battleCard({ id: 8, code: "morgan_axe_hand", name: "Morgan", title: "Axe-Hand", rarity: "C", arc: "East Blue", faction: "Marines", variant: "Captain", type: "Bruiser", atk: 72, hp: 760, speed: 45, basePower: 860, weapon: "Basic Marine Saber", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 9, code: "helmeppo_spoiled_brat", name: "Helmeppo", title: "Spoiled Brat", rarity: "C", arc: "East Blue", faction: "Marines", variant: "Early Days", type: "Speed Fighter", atk: 48, hp: 500, speed: 62, basePower: 830, weapon: "Basic Marine Saber", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 10, code: "buggy_the_clown", name: "Buggy The Clown", title: "The Clown", rarity: "B", arc: "East Blue", faction: "Buggy Pirates", variant: "Chop-Chop Fruit", type: "Trickster", atk: 95, hp: 760, speed: 70, basePower: 1400, weapon: "Dual Daggers", devilFruit: "Bara Bara no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 11, code: "kuro_hundred_plans", name: "Kuro", title: "Of a Hundred Plans", rarity: "B", arc: "East Blue", faction: "Black Cat Pirates", variant: "Shakushi", type: "Assassin", atk: 102, hp: 700, speed: 96, basePower: 1200, weapon: "Cat Claws", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 12, code: "jango_hypnotist", name: "Jango", title: "Hypnotist", rarity: "C", arc: "East Blue", faction: "Black Cat Pirates", variant: "Hypnosis", type: "Control", atk: 56, hp: 540, speed: 73, basePower: 855, weapon: "Hypnosis Ring", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 13, code: "don_krieg_admiral", name: "Don Krieg", title: "Admiral", rarity: "B", arc: "East Blue", faction: "Krieg Pirates", variant: "Battle Armor", type: "Tank", atk: 105, hp: 880, speed: 55, basePower: 1300, weapon: "Wootz Steel Spear", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 14, code: "gin_man_demon", name: "Gin", title: "Man-Demon", rarity: "B", arc: "East Blue", faction: "Krieg Pirates", variant: "Tonfa Master", type: "Fighter", atk: 98, hp: 760, speed: 82, basePower: 1257, weapon: "Tonfa", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 15, code: "arlong_saw", name: "Arlong", title: "Saw", rarity: "A", arc: "East Blue", faction: "Arlong Pirates", variant: "Fish-Man", type: "Bruiser", atk: 135, hp: 980, speed: 68, basePower: 1500, weapon: "Kiribachi", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 16, code: "hatchan_six_sword_style", name: "Hatchan", title: "Six-Sword Style", rarity: "B", arc: "East Blue", faction: "Arlong Pirates", variant: "Octopus Swordsman", type: "Attacker", atk: 92, hp: 780, speed: 66, basePower: 1455, weapon: "Six Swords", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 17, code: "smoker_white_hunter", name: "Smoker", title: "White Hunter", rarity: "A", arc: "Loguetown", faction: "Marines", variant: "Smoke-Smoke Fruit", type: "Control", atk: 128, hp: 930, speed: 82, basePower: 1780, weapon: "Jitte", devilFruit: "Moku Moku no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 18, code: "tashigi_swordswoman", name: "Tashigi", title: "Swordswoman", rarity: "B", arc: "Loguetown", faction: "Marines", variant: "Base", type: "Attacker", atk: 92, hp: 720, speed: 78, basePower: 1775, weapon: "Basic Marine Saber", devilFruit: "None", equipType: "Weapon", image: "" }),
  ...
  battleCard({ id: 105, code: "shanks_red_hair", name: "Shanks", title: "Red Hair", rarity: "S", arc: "Final Saga", faction: "Red Hair Pirates", variant: "Divine Departure", type: "Legend", atk: 248, hp: 1500, speed: 96, basePower: 2497, weapon: "Gryphon", devilFruit: "None", equipType: "Weapon", image: "" }),
  ...
  battleCard({ id: 112, code: "warcury", name: "Saint Topman Warcury", title: "Warrior God of Justice", rarity: "S", arc: "Egghead", faction: "World Government", variant: "Demonic Form", type: "Legend", atk: 238, hp: 1680, speed: 60, basePower: 2485, weapon: "None", devilFruit: "Hito Hito no Mi, Model: Fengxi", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 117, code: "loki", name: "Loki", title: "Prince of Elbaf", rarity: "S", arc: "Elbaf", faction: "Elbaf", variant: "Giant Warrior", type: "Bruiser", atk: 250, hp: 1700, speed: 70, weapon: "Ragnir", basePower: 2495, devilFruit: "Ryu Ryu no Mi, Model: Nidhöggr", equipType: "Devil Fruit", image: "" }),
...
const SPECIAL_FORMS = {
  ...
  bepo_navigator_support: ["Sabaody Archipelago Arc", "Heart Pirates Arc", "Final War Arc"],
  killer_massacre_soldier: ["Sabaody Archipelago Arc", "Wano Country Arc", "Rooftop War Arc"],
  marco_phoenix: ["Marineford Arc", "Wano Country Arc", "Whitebeard Remnants Arc"],
  ben_beckman: ["Romance Dawn Arc", "Post-Enies Lobby Arc", "Egghead Arc"],
  charlotte_pudding: ["Whole Cake Island Arc", "Whole Cake Island Arc", "Whole Cake Island Arc"],
  mansherry_healing_princess: ["Dressrosa Arc", "Revolution Support Arc", "Healing Kingdom Arc"],
  vegapunk_stella: ["Dragon Arc", "Egghead Arc", "World Knowledge Arc"],
  //lindbergh_revolutionary_genius: ["Revolutionary Army Arc", "Mary Geoise Raid Arc", "Final War Arc"],
  //doc_q_sickly_support : ["Jaya Arc", "Wano Arc", "Blackbeard Pirates Arc"],
