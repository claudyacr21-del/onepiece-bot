...
const BASE_CARDS = [
  ...
  battleCard({ id: 10, code: "buggy_the_clown", name: "Buggy The Clown", title: "The Clown", rarity: "B", arc: "East Blue", faction: "Buggy Pirates", variant: "Chop-Chop Fruit", type: "Trickster", atk: 95, hp: 760, speed: 70, weapon: "Dual Daggers", devilFruit: "Bara Bara no Mi", equipType: "Devil Fruit", image: "" }),
  ...
  boostCard({ id: 20, code: "kaya_medical_patron", name: "Kaya", title: "Medical Patron", rarity: "C", arc: "East Blue", faction: "Syrup Village", variant: "Storage Support", boostType: "fragmentstorage", boostValue: 18, boostTarget: "account", boostDescription: "Increase fragment storage by 25 passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  ...
  battleCard({ id: 102, code: "akainu", name: "Sakazuki", title: "Akainu", rarity: "UR", arc: "Marineford", faction: "Marines", variant: "Magma Emperor", type: "Legend", atk: 245, hp: 1540, speed: 74, weapon: "Magma Fist", devilFruit: "Magu Magu no Mi", secondaryDevilFruit: "Gura Gura no Mi", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 109, code: "dragon_revolutionary_leader", name: "Monkey D. Dragon", title: "Revolutionary Leader", rarity: "UR", arc: "Final Saga", faction: "Revolutionary Army", variant: "Storm Vanguard", type: "Legend", atk: 240, hp: 1480, speed: 94, weapon: "None", devilFruit: "Arashi Arashi no Mi", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 115, code: "imu", name: "Saint Nerona Imu", title: "Sovereign of the Void", rarity: "UR", arc: "Final Saga", faction: "World Government", variant: "Shadow Throne", type: "Legend", atk: 275, hp: 1800, speed: 95, weapon: "None", devilFruit: "Akuma no Mi", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 127, code: "kaido_strongest_creature", name: "Kaido", title: "Strongest Creature", rarity: "UR", arc: "Wano", faction: "Beast Pirates", variant: "Azure Dragon Emperor", type: "Legend", atk: 258, hp: 1680, speed: 78, weapon: "Hassaikai", devilFruit: "Uo Uo no Mi, Model: Seiryu", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 128, code: "doflamingo_heavenly_demon", name: "Donquixote Doflamingo", title: "Heavenly Demon", rarity: "S", arc: "Dressrosa", faction: "Donquixote Pirates", variant: "String Tyrant", type: "Control", atk: 182, hp: 1160, speed: 86, weapon: "None", devilFruit: "Ito Ito no Mi", equipType: "Devil Fruit", image: "" })
];

const EXTRA_CANON_CARDS = [
  battleCard({ id: 129, code: "sabo_flame_emperor", name: "Sabo", title: "Flame Emperor", rarity: "S", arc: "Dressrosa", faction: "Revolutionary Army", variant: "Mera Successor", type: "Burst", atk: 178, hp: 1040, speed: 94, weapon: "Dragon Claw Gloves", devilFruit: "Mera Mera no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 130, code: "fujitora", name: "Issho", title: "Fujitora", rarity: "S", arc: "Dressrosa", faction: "Marines", variant: "Gravity Blade", type: "Control", atk: 170, hp: 1180, speed: 72, weapon: "Shikomizue", devilFruit: "Zushi Zushi no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 131, code: "katakuri_strongest_sweet_commander", name: "Charlotte Katakuri", title: "Strongest Sweet Commander", rarity: "S", arc: "Whole Cake Island", faction: "Big Mom Pirates", variant: "Future Sight", type: "Control", atk: 184, hp: 1160, speed: 90, weapon: "Mogura", devilFruit: "Mochi Mochi no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 132, code: "big_mom_emperor", name: "Charlotte Linlin", title: "Big Mom", rarity: "UR", arc: "Whole Cake Island", faction: "Big Mom Pirates", variant: "Soul Emperor", type: "Legend", atk: 236, hp: 1700, speed: 66, weapon: "Napoleon", devilFruit: "Soru Soru no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 133, code: "shiryu", name: "Shiryu", title: "Rain of the All-Out War", rarity: "S", arc: "Blackbeard Pirates", faction: "Blackbeard Pirates", variant: "Invisible Slayer", type: "Assassin", atk: 188, hp: 1080, speed: 92, weapon: "Raiu", devilFruit: "Suke Suke no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 134, code: "boa_seraphim", name: "S-Snake", title: "Boa Seraphim", rarity: "A", arc: "Egghead", faction: "World Government", variant: "Pacifista Model", type: "Control", atk: 150, hp: 980, speed: 82, weapon: "Laser Kicks", devilFruit: "Mero Mero no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 135, code: "mihawk_seraphim", name: "S-Hawk", title: "Mihawk Seraphim", rarity: "A", arc: "Egghead", faction: "World Government", variant: "Pacifista Model", type: "Attacker", atk: 158, hp: 960, speed: 86, weapon: "Black Blade Replica", devilFruit: "Supa Supa no Mi", equipType: "Devil Fruit", image: "" })
];

const EXTRA_REQ_SUPPORT = [
  boostCard({ id: 136, code: "germa_lineage_factor", name: "Germa Lineage Factor", title: "Germa Factor", rarity: "A", arc: "Support", faction: "Passive", variant: "Genetic Boost", boostType: "spd", boostValue: 6, boostTarget: "team", boostDescription: "Increase team SPD by 6% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 137, code: "gravity_sheath", name: "Gravity Sheath", title: "Gravity Sheath", rarity: "A", arc: "Support", faction: "Passive", variant: "Heavy Pressure", boostType: "hp", boostValue: 6, boostTarget: "team", boostDescription: "Increase team HP by 6% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 138, code: "holy_knight_standard", name: "Holy Knight Standard", title: "Holy Standard", rarity: "S", arc: "Support", faction: "Passive", variant: "Celestial Authority", boostType: "atk", boostValue: 7, boostTarget: "team", boostDescription: "Increase team ATK by 7% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 139, code: "revolutionary_banner", name: "Revolutionary Banner", title: "Freedom Banner", rarity: "S", arc: "Support", faction: "Passive", variant: "Freedom Uprising", boostType: "dmg", boostValue: 7, boostTarget: "team", boostDescription: "Increase team damage by 7% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  ...
  boostCard({ id: 141, code: "donquixote_family", name: "Donquixote Family", title: "Donquixote Family", rarity: "A", arc: "Support", faction: "Passive", variant: "Underworld Strings", boostType: "dmg", boostValue: 6, boostTarget: "team", boostDescription: "Increase team damage by 6% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 142, code: "beast_pirates_terror", name: "Beast Pirates Terror", title: "Beast Pirates Terror", rarity: "S", arc: "Support", faction: "Passive", variant: "Calamity Fear", boostType: "hp", boostValue: 7, boostTarget: "team", boostDescription: "Increase team HP by 7% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 143, code: "sweet_commander_pride", name: "Sweet Commander Pride", title: "Sweet Commander Pride", rarity: "A", arc: "Support", faction: "Passive", variant: "Totto Land Might", boostType: "atk", boostValue: 6, boostTarget: "team", boostDescription: "Increase team ATK by 6% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 144, code: "cp0_mask", name: "CP0 Mask", title: "Cipher Pol Mask", rarity: "A", arc: "Support", faction: "Passive", variant: "Silent Order", boostType: "spd", boostValue: 6, boostTarget: "team", boostDescription: "Increase team SPD by 6% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  ...
  boostCard({ id: 146, code: "marineford_legacy", name: "Marineford Legacy", title: "Marineford Legacy", rarity: "S", arc: "Support", faction: "Passive", variant: "War Memory", boostType: "exp", boostValue: 10, boostTarget: "account", boostDescription: "Increase EXP gain by 10% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 147, code: "cross_guild_bounty", name: "Cross Guild Bounty", title: "Cross Guild Bounty", rarity: "A", arc: "Support", faction: "Passive", variant: "Hunter Incentive", boostType: "fragmentstorage", boostValue: 55, boostTarget: "account", boostDescription: "Increase fragment storage by 75 passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 148, code: "god_valley_echo", name: "God Valley Echo", title: "God Valley Echo", rarity: "UR", arc: "Support", faction: "Passive", variant: "Lost History", boostType: "daily", boostValue: 3, boostTarget: "account", boostDescription: "Increase daily reward quality by 3 tiers passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 149, code: "elbaf_might", name: "Elbaf Might", title: "Elbaf Might", rarity: "S", arc: "Support", faction: "Passive", variant: "Giant Valor", boostType: "hp", boostValue: 7, boostTarget: "team", boostDescription: "Increase team HP by 7% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 150, code: "void_century_fragment", name: "Void Century Fragment", title: "Void Century Fragment", rarity: "UR", arc: "Support", faction: "Passive", variant: "Forbidden Record", boostType: "exp", boostValue: 12, boostTarget: "account", boostDescription: "Increase EXP gain by 12% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 151, code: "relic_of_joy", name: "Relic of Joy", title: "Relic of Joy", rarity: "UR", arc: "Support", faction: "Passive", variant: "Liberation Relic", boostType: "pullchance", boostValue: 3, boostTarget: "account", boostDescription: "Increase pull chance by 3 steps passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  boostCard({ id: 152, code: "pirate_king_log", name: "Pirate King Log", title: "Pirate King Log", rarity: "UR", arc: "Support", faction: "Passive", variant: "Great Voyage Record", boostType: "daily", boostValue: 3, boostTarget: "account", boostDescription: "Increase daily reward quality by 3 tiers passively.", devilFruit: "None", equipType: "Passive", image: "" })
];

const EXTRA_CHARACTER_CARDS = [
  battleCard({ id: 153, code: "corazon", name: "Donquixote Rosinante", title: "Corazon", rarity: "A", arc: "Dressrosa", faction: "Marines", variant: "Silent Heart", type: "Support", atk: 112, hp: 860, speed: 84, weapon: "Silencer Handgun", devilFruit: "Nagi Nagi no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 154, code: "yasopp", name: "Yasopp", title: "Red-Hair Sniper", rarity: "S", arc: "Final Saga", faction: "Red Hair Pirates", variant: "Deadeye", type: "Ranged", atk: 176, hp: 980, speed: 96, weapon: "Long Rifle", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 155, code: "sentomaru", name: "Sentomaru", title: "Defense Captain", rarity: "A", arc: "Sabaody", faction: "Marines", variant: "Axe Guard", type: "Tank", atk: 144, hp: 1100, speed: 60, weapon: "Battle Axe", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 156, code: "gan_fall", name: "Gan Fall", title: "Sky Knight", rarity: "B", arc: "Skypiea", faction: "Skypiea", variant: "Sky Lance", type: "Attacker", atk: 102, hp: 760, speed: 74, weapon: "Sky Lance", devilFruit: "None", equipType: "Weapon", image: "" }),
