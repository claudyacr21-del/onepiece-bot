...
const BASE_CARDS = [
  ...
  // =========================
  battleCard({ id: 1, code: "luffy_straw_hat", name: "Monkey D. Luffy", title: "Straw Hat", rarity: "A", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Base", type: "Captain", atk: 211, hp: 1300, speed: 80, basePower: 2000, weapon: "Sandals", devilFruit: "Hito Hito no Mi, Model: Nika", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 2, code: "zoro_pirate_hunter", name: "Roronoa Zoro", title: "Pirate Hunter", rarity: "A", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Three Sword Style", type: "Attacker", atk: 200, hp: 1100, speed: 70, basePower: 1990, weapon: "Wado Ichimonjii, Sandai Kitetsu, Enma", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 3, code: "nami_cat_burglar", name: "Nami", title: "Cat Burglar", rarity: "B", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Base", type: "Support", atk: 155, hp: 600, speed: 65, basePower: 1470, weapon: "Clima Tact", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 4, code: "usopp_sniper", name: "Usopp", title: "Sniper", rarity: "B", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Base", type: "Ranged", atk: 140, hp: 620, speed: 88, basePower: 1450, weapon: "Basic Slingshot", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 5, code: "sanji_black_leg", name: "Sanji", title: "Black Leg", rarity: "A", arc: "East Blue", faction: "Straw Hat Pirates", variant: "Base", type: "Speed Fighter", atk: 195, hp: 1000, speed: 75, basePower: 1970, weapon: "Black Leg Combat Shoes", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 6, code: "koby_aspiring_marine", name: "Koby", title: "Aspiring Marine", rarity: "B", arc: "East Blue", faction: "Marines", variant: "Early Days", type: "Support", atk: 170, hp: 1220, speed: 75, basePower: 1775, weapon: "None", devilFruit: "None", equipType: "None", image: "" }),
  battleCard({ id: 7, code: "alvida_iron_club", name: "Alvida", title: "Iron Club", rarity: "C", arc: "East Blue", faction: "Alvida Pirates", variant: "Base", type: "Bruiser", atk: 122, hp: 740, speed: 42, basePower: 850, weapon: "Basic Iron Club", devilFruit: "Sube Sube no Mi", equipType: "Weapon", image: "" }),
  battleCard({ id: 8, code: "morgan_axe_hand", name: "Morgan", title: "Axe-Hand", rarity: "C", arc: "East Blue", faction: "Marines", variant: "Captain", type: "Bruiser", atk: 128, hp: 760, speed: 45, basePower: 860, weapon: "Basic Marine Saber", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 9, code: "helmeppo_spoiled_brat", name: "Helmeppo", title: "Spoiled Brat", rarity: "C", arc: "East Blue", faction: "Marines", variant: "Early Days", type: "Speed Fighter", atk: 114, hp: 500, speed: 62, basePower: 830, weapon: "Basic Marine Saber", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 10, code: "buggy_the_clown", name: "Buggy The Clown", title: "The Clown", rarity: "B", arc: "East Blue", faction: "Buggy Pirates", variant: "Chop-Chop Fruit", type: "Trickster", atk: 138, hp: 760, speed: 70, basePower: 1400, weapon: "Dual Daggers", devilFruit: "Bara Bara no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 11, code: "kuro_hundred_plans", name: "Kuro", title: "Of a Hundred Plans", rarity: "B", arc: "East Blue", faction: "Black Cat Pirates", variant: "Shakushi", type: "Assassin", atk: 125, hp: 700, speed: 96, basePower: 1200, weapon: "Cat Claws", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 12, code: "jango_hypnotist", name: "Jango", title: "Hypnotist", rarity: "C", arc: "East Blue", faction: "Black Cat Pirates", variant: "Hypnosis", type: "Control", atk: 112, hp: 540, speed: 73, basePower: 855, weapon: "Hypnosis Ring", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 13, code: "don_krieg_admiral", name: "Don Krieg", title: "Admiral", rarity: "B", arc: "East Blue", faction: "Krieg Pirates", variant: "Battle Armor", type: "Tank", atk: 120, hp: 880, speed: 55, basePower: 1300, weapon: "Wootz Steel Spear", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 14, code: "gin_man_demon", name: "Gin", title: "Man-Demon", rarity: "B", arc: "East Blue", faction: "Krieg Pirates", variant: "Tonfa Master", type: "Fighter", atk: 118, hp: 760, speed: 82, basePower: 1257, weapon: "Tonfa", devilFruit: "None", equipType: "Weapon", image: "" }),
  ...
  battleCard({ id: 16, code: "hatchan_six_sword_style", name: "Hatchan", title: "Six-Sword Style", rarity: "B", arc: "East Blue", faction: "Arlong Pirates", variant: "Octopus Swordsman", type: "Attacker", atk: 110, hp: 780, speed: 66, basePower: 1455, weapon: "Six Swords", devilFruit: "None", equipType: "Weapon", image: "" }),
  ...
  battleCard({ id: 18, code: "tashigi_swordswoman", name: "Tashigi", title: "Swordswoman", rarity: "B", arc: "Loguetown", faction: "Marines", variant: "Base", type: "Attacker", atk: 134, hp: 720, speed: 78, basePower: 1775, weapon: "Basic Marine Saber", devilFruit: "None", equipType: "Weapon", image: "" }),

  // =========================
  // Passive / Boost cards
  // =========================
  boostCard({ id: 19, code: "chopper_cotton_candy_lover", name: "Tony Tony Chopper", title: "Cotton Candy Lover", rarity: "C", arc: "Drum Island", faction: "Straw Hat Pirates", variant: "Doctor Support", boostType: "daily", boostValue: 1, boostTarget: "account", basePower: 250, boostDescription: "Increase daily reward quality by 1 tier passively.", devilFruit: "Hito Hito no Mi, Model: Tonakai", equipType: "Devil Fruit", image: "" }),
  ...
  boostCard({ id: 49, code: "soul_solid", name: "Soul Solid Boost", title: "Soul Solid", rarity: "A", arc: "Support", faction: "Passive", variant: "Soul Blade", boostType: "dmg", boostValue: 5, boostTarget: "team", basePower: 1450, boostDescription: "Increase team damage by 5% passively.", devilFruit: "None", equipType: "Passive", image: "" }),
  ...
  battleCard({ id: 86, code: "enel_god", name: "Enel", title: "God", rarity: "S", arc: "Skypiea", faction: "Skypiea", variant: "Thunder God", type: "Control", atk: 206, hp: 1180, speed: 96, basePower: 2200, weapon: "Nonosama Bo", devilFruit: "Goro Goro no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 87, code: "franky_cyborg", name: "Franky", title: "Cyborg", rarity: "A", arc: "Water 7", faction: "Straw Hat Pirates", variant: "Battle Franky", type: "Tank", atk: 162, hp: 1140, speed: 64, basePower: 1850, weapon: "General Franky Arsenal", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 88, code: "lucci_cp9", name: "Rob Lucci", title: "CP9", rarity: "S", arc: "Enies Lobby", faction: "World Government", variant: "Leopard Form", type: "Assassin", atk: 182, hp: 1020, speed: 100, basePower: 2250, weapon: "Rokushiki Gauntlets", devilFruit: "Neko Neko no Mi, Model: Leopard", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 89, code: "kaku_cp9", name: "Kaku", title: "CP9", rarity: "A", arc: "Enies Lobby", faction: "World Government", variant: "Giraffe Form", type: "Attacker", atk: 155, hp: 960, speed: 78, basePower: 1850, weapon: "None", devilFruit: "Ushi Ushi no Mi, Model: Giraffe", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 90, code: "brook_soul_king", name: "Brook", title: "Soul King", rarity: "A", arc: "Thriller Bark", faction: "Straw Hat Pirates", variant: "Soul Form", type: "Speed Fighter", atk: 165, hp: 780, speed: 100, basePower: 1820, weapon: "Soul Solid", devilFruit: "Yomi Yomi no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 91, code: "gecko_moria", name: "Gecko Moria", title: "Shadow Master", rarity: "A", arc: "Thriller Bark", faction: "Thriller Bark Pirates", variant: "Shadow Asgard", type: "Control", atk: 170, hp: 1220, speed: 58, basePower: 1750, weapon: "Scissors", devilFruit: "Kage Kage no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 92, code: "bartholomew_kuma", name: "Bartholomew Kuma", title: "Tyrant", rarity: "S", arc: "Thriller Bark", faction: "Revolutionary Army", variant: "Pacifista Palm", type: "Tank", atk: 185, hp: 1260, speed: 70, basePower: 2300, weapon: "Bible", devilFruit: "Nikyu Nikyu no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 93, code: "boa_hancock", name: "Boa Hancock", title: "Pirate Empress", rarity: "S", arc: "Amazon Lily", faction: "Kuja Pirates", variant: "Love Beam", type: "Control", atk: 210, hp: 1290, speed: 92, basePower: 2258, weapon: "None", devilFruit: "Mero Mero no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 94, code: "jinbe_first_son_of_the_sea", name: "Jinbe", title: "First Son of the Sea", rarity: "A", arc: "Marineford", faction: "Straw Hat Pirates", variant: "Fish-Man Karate", type: "Tank", atk: 146, hp: 1380, speed: 72, basePower: 1950, weapon: "Fish-Man Karate", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 95, code: "ace_fire_fist", name: "Portgas D. Ace", title: "Fire Fist", rarity: "A", arc: "Marineford", faction: "Whitebeard Pirates", variant: "Flame Emperor", type: "Burst", atk: 225, hp: 1150, speed: 75, basePower: 2000, weapon: "Hat", devilFruit: "Mera Mera no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 96, code: "whitebeard_strongest_man", name: "Edward Newgate", title: "Strongest Man", rarity: "S", arc: "Marineford", faction: "Whitebeard Pirates", variant: "Earthshaker", type: "Legend", atk: 260, hp: 1660, speed: 72, basePower: 2480, weapon: "Bisento", devilFruit: "Gura Gura no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 98, code: "blackbeard_emperor_of_darkness", name: "Marshall D. Teach", title: "Emperor of Darkness", rarity: "S", arc: "Final Saga", faction: "Blackbeard Pirates", variant: "Dual Devil Fruits", type: "Legend", atk: 259, hp: 1580, speed: 80, basePower: 2450, weapon: "Kagi", devilFruit: "Yami Yami no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 100, code: "garp_hero_of_the_marines", name: "Monkey D. Garp", title: "Hero of the Marines", rarity: "S", arc: "Marineford", faction: "Marines", variant: "Galaxy Impact", type: "Legend", atk: 262, hp: 1600, speed: 85, basePower: 2460, weapon: "Fists", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 101, code: "sengoku_buddha", name: "Sengoku", title: "The Buddha", rarity: "S", arc: "Marineford", faction: "Marines", variant: "Golden Buddha", type: "Tank", atk: 220, hp: 1350, speed: 65, basePower: 2410, weapon: "None", devilFruit: "Hito Hito no Mi, Model: Daibutsu", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 102, code: "akainu", name: "Sakazuki", title: "Akainu", rarity: "S", arc: "Marineford", faction: "Marines", variant: "Magma Emperor", type: "Legend", atk: 235, hp: 1440, speed: 74, basePower: 2420, weapon: "Magma Fist", devilFruit: "Magu Magu no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 103, code: "aokiji", name: "Kuzan", title: "Aokiji", rarity: "S", arc: "Marineford", faction: "Marines", variant: "Ice Age", type: "Control", atk: 233, hp: 1440, speed: 84, basePower: 2370, weapon: "Ice Saber", devilFruit: "Hie Hie no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 104, code: "kizaru", name: "Borsalino", title: "Kizaru", rarity: "S", arc: "Marineford", faction: "Marines", variant: "Light-Speed Assault", type: "Speed Fighter", atk: 235, hp: 1440, speed: 104, basePower: 2420, weapon: "Ame no Murakumo", devilFruit: "Pika Pika no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 105, code: "shanks_red_hair", name: "Shanks", title: "Red Hair", rarity: "S", arc: "Final Saga", faction: "Red Hair Pirates", variant: "Divine Departure", type: "Legend", atk: 265, hp: 1600, speed: 90, basePower: 2420, weapon: "Gryphon", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 106, code: "mihawk_hawk_eyes", name: "Dracule Mihawk", title: "Hawk Eyes", rarity: "S", arc: "Final Saga", faction: "Cross Guild", variant: "Strongest Swordsman", type: "Legend", atk: 261.5, hp: 1550, speed: 88, basePower: 2420, weapon: "Yoru", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 107, code: "roger_king_of_the_pirates", name: "Gol D. Roger", title: "King of the Pirates", rarity: "S", arc: "Flashback", faction: "Roger Pirates", variant: "Divine Departure", type: "Legend", atk: 262, hp: 1600, speed: 85, basePower: 2460, weapon: "Aces", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 108, code: "xebec_captain_of_rocks", name: "Rocks D. Xebec", title: "Captain of Rocks", rarity: "S", arc: "God Valley", faction: "Rocks Pirates", variant: "Chaos Sovereign", type: "Legend", atk: 267, hp: 1650, speed: 88, basePower: 2490, weapon: "Eclipse", devilFruit: "None", equipType: "Weapon", image: "" }),
  ...
  battleCard({ id: 110, code: "saturn", name: "Saint Jaygarcia Saturn", title: "Warrior God of Science and Defense", rarity: "S", arc: "Egghead", faction: "World Government", variant: "Demonic Form", type: "Legend", atk: 236, hp: 1620, speed: 75, basePower: 2465, weapon: "None", devilFruit: "Ushi Ushi no Mi, Model: Gyuki", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 111, code: "mars", name: "Saint Marcus Mars", title: "Warrior God of Environment", rarity: "S", arc: "Egghead", faction: "World Government", variant: "Demonic Form", type: "Legend", atk: 244, hp: 1600, speed: 80, basePower: 2470, weapon: "None", devilFruit: "Tori Tori no Mi, Model: Itsumade", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 112, code: "warcury", name: "Saint Topman Warcury", title: "Warrior God of Justice", rarity: "S", arc: "Egghead", faction: "World Government", variant: "Demonic Form", type: "Legend", atk: 248, hp: 1680, speed: 80, basePower: 2485, weapon: "None", devilFruit: "Hito Hito no Mi, Model: Fengxi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 113, code: "nusjuro", name: "Saint Ethanbaron V Nusjuro", title: "Warrior God of Finance", rarity: "S", arc: "Egghead", faction: "World Government", variant: "Demonic Form", type: "Legend", atk: 242, hp: 1480, speed: 82, basePower: 2480, weapon: "Shodai Kitetsu", devilFruit: "Uma Uma no Mi, Model: Bakotsu", equipType: "Weapon", image: "" }),
  battleCard({ id: 114, code: "ju_peter", name: "Saint Shepherd Ju Peter", title: "Warrior God of Agriculture", rarity: "S", arc: "Egghead", faction: "World Government", variant: "Demonic Form", type: "Legend", atk: 232, hp: 1640, speed: 80, basePower: 2475, weapon: "None", devilFruit: "Mushi Mushi no Mi, Model: Sandworm", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 115, code: "imu", name: "Saint Nerona Imu", title: "Sovereign of the Void", rarity: "S", arc: "Final Saga", faction: "World Government", variant: "Shadow Throne", type: "Legend", atk: 275, hp: 1800, speed: 95, basePower: 2600, weapon: "Nemesis", devilFruit: "Akuma no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 116, code: "garling", name: "Figarland Garling", title: "Holy Knight Commander", rarity: "S", arc: "Final Saga", faction: "Holy Knights", variant: "Sacred Executioner", type: "Attacker", atk: 238, hp: 1480, speed: 77, basePower: 2465, weapon: "Sacred Saber", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 117, code: "loki", name: "Loki", title: "Prince of Elbaf", rarity: "S", arc: "Elbaf", faction: "Elbaf", variant: "Giant Warrior", type: "Bruiser", atk: 261, hp: 1750, speed: 72, weapon: "Ragnir", basePower: 2495, devilFruit: "Ryu Ryu no Mi, Model: Nidhöggr", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 118, code: "rayleigh_dark_king", name: "Silvers Rayleigh", title: "Dark King", rarity: "S", arc: "Sabaody", faction: "Roger Pirates", variant: "Prime Haki", type: "Legend", atk: 258, hp: 1490, speed: 90, basePower: 2455, weapon: "Long Sword", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 119, code: "oden", name: "Kozuki Oden", title: "Lord of Wano", rarity: "S", arc: "Wano", faction: "Kozuki Clan", variant: "Togen Totsuka", type: "Legend", atk: 220, hp: 1480, speed: 84, basePower: 2450, weapon: "Ex-Enma, Ex-Habakiri", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 120, code: "perospero", name: "Perospero", title: "Candy Minister", rarity: "A", arc: "Whole Cake Island", faction: "Big Mom Pirates", variant: "Candy Wall", type: "Control", atk: 155, hp: 960, speed: 74, basePower: 1800, weapon: "Candy Cane", devilFruit: "Pero Pero no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 121, code: "trebol_underworld_support", name: "Trebol", title: "Underworld Broker", rarity: "A", arc: "Dressrosa", faction: "Donquixote Pirates", variant: "Sticky Trap", type: "Control", atk: 142, hp: 1020, speed: 58, basePower: 1800, weapon: "None", devilFruit: "Beta Beta no Mi", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 125, code: "yamato_oni_princess", name: "Yamato", title: "Oni Princess", rarity: "S", arc: "Wano", faction: "Wano", variant: "Guardian Wolf", type: "Fighter", atk: 238, hp: 1350, speed: 82, basePower: 2280, weapon: "Kanabo", devilFruit: "Inu Inu no Mi, Model: Okuchi no Makami", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 126, code: "greenbull", name: "Aramaki", title: "Ryokugyu", rarity: "S", arc: "Wano", faction: "Marines", variant: "Forest Admiral", type: "Control", atk: 204, hp: 1400, speed: 70, basePower: 2250, weapon: "None", devilFruit: "Mori Mori no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 127, code: "kaido_strongest_creature", name: "Kaido", title: "Strongest Creature", rarity: "S", arc: "Wano", faction: "Beast Pirates", variant: "Azure Dragon Emperor", type: "Legend", atk: 260, hp: 1680, speed: 80, basePower: 2420, weapon: "Hassaikai", devilFruit: "Uo Uo no Mi, Model: Seiryu", equipType: "Devil Fruit", image: "" }),
...
const EXTRA_CANON_CARDS = [
  battleCard({ id: 129, code: "sabo_flame_emperor", name: "Sabo", title: "Flame Emperor", rarity: "S", arc: "Dressrosa", faction: "Revolutionary Army", variant: "Mera Successor", type: "Burst", atk: 225, hp: 1340, speed: 94, basePower: 2400, weapon: "Dragon Claw Gloves", devilFruit: "Mera Mera no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 130, code: "fujitora", name: "Issho", title: "Fujitora", rarity: "S", arc: "Dressrosa", faction: "Marines", variant: "Gravity Blade", type: "Control", atk: 200, hp: 1380, speed: 75, basePower: 2250, weapon: "Shikomizue", devilFruit: "Zushi Zushi no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 131, code: "katakuri_strongest_sweet_commander", name: "Charlotte Katakuri", title: "Strongest Sweet Commander", rarity: "S", arc: "Whole Cake Island", faction: "Big Mom Pirates", variant: "Future Sight", type: "Control", atk: 230, hp: 1260, speed: 87, basePower: 2350, weapon: "Mogura", devilFruit: "Mochi Mochi no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 132, code: "big_mom_emperor", name: "Charlotte Linlin", title: "Big Mom", rarity: "S", arc: "Whole Cake Island", faction: "Big Mom Pirates", variant: "Soul Emperor", type: "Legend", atk: 245, hp: 1680, speed: 74, basePower: 2410, weapon: "Napoleon", devilFruit: "Soru Soru no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 133, code: "shiryu", name: "Shiryu", title: "Rain of the All-Out War", rarity: "A", arc: "Blackbeard Pirates", faction: "Blackbeard Pirates", variant: "Invisible Slayer", type: "Assassin", atk: 155, hp: 1080, speed: 72, basePower: 1950, weapon: "Raiu", devilFruit: "Suke Suke no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 134, code: "boa_seraphim", name: "S-Snake", title: "Boa Seraphim", rarity: "A", arc: "Egghead", faction: "World Government", variant: "Pacifista Model", type: "Control", atk: 175, hp: 980, speed: 82, basePower: 1900, weapon: "Laser Kicks", devilFruit: "Mero Replica", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 135, code: "mihawk_seraphim", name: "S-Hawk", title: "Mihawk Seraphim", rarity: "A", arc: "Egghead", faction: "World Government", variant: "Pacifista Model", type: "Attacker", atk: 175, hp: 960, speed: 86, basePower: 1900, weapon: "Black Blade Replica", devilFruit: "Supa Supa no Mi", equipType: "Devil Fruit", image: "" })
];
...
const EXTRA_CHARACTER_CARDS = [
  battleCard({ id: 153, code: "corazon", name: "Donquixote Rosinante", title: "Corazon", rarity: "A", arc: "Dressrosa", faction: "Marines", variant: "Silent Heart", type: "Support", atk: 117, hp: 860, speed: 84, basePower: 1700, weapon: "Silencer Handgun", devilFruit: "Nagi Nagi no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 154, code: "yasopp", name: "Yasopp", title: "Red-Hair Sniper", rarity: "S", arc: "Final Saga", faction: "Red Hair Pirates", variant: "Deadeye", type: "Ranged", atk: 220, hp: 1320, speed: 96, basePower: 2400, weapon: "Long Rifle", devilFruit: "None", equipType: "Weapon", image: "" }),
  ...
  battleCard({ id: 156, code: "gan_fall", name: "Gan Fall", title: "Sky Knight", rarity: "B", arc: "Skypiea", faction: "Skypiea", variant: "Sky Lance", type: "Attacker", atk: 115, hp: 760, speed: 74, basePower: 1450, weapon: "Sky Lance", devilFruit: "None", equipType: "Weapon", image: "" }),
  ...
  battleCard({ id: 158, code: "mr3", name: "Galdino", title: "Mr. 3", rarity: "B", arc: "Little Garden", faction: "Baroque Works", variant: "Wax Sculptor", type: "Control", atk: 128, hp: 700, speed: 68, basePower: 1350, weapon: "Wax Blade", devilFruit: "Doru Doru no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 159, code: "wapol", name: "Wapol", title: "Bliking King", rarity: "B", arc: "Drum Island", faction: "Drum Kingdom", variant: "Metal Mouth", type: "Bruiser", atk: 122, hp: 820, speed: 56, basePower: 1200, weapon: "Cannon Jaw", devilFruit: "Baku Baku no Mi", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 161, code: "gunko_holy_knight", name: "Manmayer Gunko", title: "Holy Knight", rarity: "S", arc: "Elbaf", faction: "Holy Knights", variant: "Arrow Executioner", type: "Control", atk: 255, hp: 1480, speed: 86, basePower: 2400, weapon: "Gauntlet", devilFruit: "Aro Aro no Mi", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 163, code: "law_surgeon_of_death", name: "Trafalgar D. Water Law", title: "Surgeon of Death", rarity: "S", arc: "Dressrosa", faction: "Heart Pirates", variant: "Room", type: "Control", atk: 230, hp: 1400, speed: 85, basePower: 2400, weapon: "Kikoku", devilFruit: "Ope Ope no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 164, code: "kid_captain", name: "Eustass Kid", title: "Captain", rarity: "S", arc: "Wano", faction: "Kid Pirates", variant: "Punk Rotten", type: "Burst", atk: 220, hp: 1360, speed: 82, basePower: 2390, weapon: "Metal Arm", devilFruit: "Jiki Jiki no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 166, code: "lzs", name: "Monster Trio", title: "Monster Trio", rarity: "M", baseTier: "M", pullTier: "MERGE", canPull: false, canPA: false, summonOnly: true, mergeOnly: true, mergeSourceCodes: ["luffy_straw_hat", "zoro_pirate_hunter", "sanji_black_leg"], mergeStatRatio: 0.4, arc: "Final Saga", faction: "Straw Hat Pirates", variant: "Luffy, Zoro & Sanji", type: "Merge", atk: 0, hp: 0, speed: 0, basePower: 0, weapon: "None", devilFruit: "None", equipType: "Devil Fruit / Weapon", image: "" }),
  battleCard({ id: 167, code: "mr2", name: "Bon Clay", title: "Bentham", rarity: "B", arc: "Alabasta", faction: "Baroque Works", variant: "Okama Kenpo", type: "Speed Fighter", atk: 128, hp: 950, speed: 92, basePower: 1460, weapon: "Okama Kenpo", devilFruit: "Mane Mane no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 168, code: "higuma", name: "Higuma", title: "Mountain Bandit", rarity: "C", arc: "Romance Dawn", faction: "Mountain Bandits", variant: "Bandit Leader", type: "Bruiser", atk: 116, hp: 700, speed: 48, basePower: 820, weapon: "Basic Marine Saber", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 169, code: "x_drake", name: "X Drake", title: "Red Flag", rarity: "A", arc: "Wano", faction: "SWORD", variant: "Allosaurus", type: "Bruiser", atk: 158, hp: 1180, speed: 76, basePower: 1950, weapon: "Saber and Axe", devilFruit: "Ryu Ryu no Mi, Model: Allosaurus", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 170, code: "scratchmen_apoo", name: "Scratchmen Apoo", title: "Roar of the Sea", rarity: "A", arc: "Wano", faction: "On Air Pirates", variant: "Soundman", type: "Control", atk: 150, hp: 940, speed: 84, basePower: 1850, weapon: "None", devilFruit: "Oto Oto no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 171, code: "charlotte_daifuku", name: "Charlotte Daifuku", title: "Bean Minister", rarity: "A", arc: "Whole Cake Island", faction: "Big Mom Pirates", variant: "Genie Summoner", type: "Control", atk: 152, hp: 1080, speed: 66, basePower: 1850, weapon: "None", devilFruit: "Hoya Hoya no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 172, code: "charlotte_oven", name: "Charlotte Oven", title: "Browned Minister", rarity: "A", arc: "Whole Cake Island", faction: "Big Mom Pirates", variant: "Heat Heat", type: "Bruiser", atk: 156, hp: 1160, speed: 62, basePower: 1850, weapon: "None", devilFruit: "Netsu Netsu no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 173, code: "charlotte_brulee", name: "Charlotte Brulee", title: "Mirror Witch", rarity: "B", arc: "Whole Cake Island", faction: "Big Mom Pirates", variant: "Mirror World", type: "Support", atk: 92, hp: 760, speed: 60, basePower: 1300, weapon: "Scythe", devilFruit: "Mira Mira no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 174, code: "basil_hawkins", name: "Basil Hawkins", title: "Magician", rarity: "A", arc: "Wano", faction: "Hawkins Pirates", variant: "Straw Man", type: "Control", atk: 150, hp: 1040, speed: 72, basePower: 1900, weapon: "Straw Sword", devilFruit: "Wara Wara no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 175, code: "capone_bege", name: "Capone Bege", title: "Gang Bege", rarity: "A", arc: "Whole Cake Island", faction: "Fire Tank Pirates", variant: "Big Father", type: "Tank", atk: 142, hp: 1300, speed: 52, basePower: 1900, weapon: "Fire Tank Arsenal", devilFruit: "Shiro Shiro no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 176, code: "neptune", name: "Neptune", title: "King of the Sea", rarity: "B", arc: "Fish-Man Island", faction: "Ryugu Kingdom", variant: "Sea King", type: "Tank", atk: 119, hp: 1080, speed: 65, basePower: 1700, weapon: "Sea Spear", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 177, code: "dorry", name: "Dorry", title: "Blue Ogre", rarity: "S", arc: "Little Garden", faction: "Giant Warrior Pirates", variant: "Elbaf Warrior", type: "Bruiser", atk: 245, hp: 1500, speed: 75, basePower: 2320, weapon: "Terry Sword", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 178, code: "brogy", name: "Brogy", title: "Red Ogre", rarity: "S", arc: "Little Garden", faction: "Giant Warrior Pirates", variant: "Elbaf Warrior", type: "Tank", atk: 245, hp: 1500, speed: 75, basePower: 2320, weapon: "Bruiser Axe", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 179, code: "emporio_ivankov", name: "Emporio Ivankov", title: "Miracle Person", rarity: "A", arc: "Impel Down", faction: "Revolutionary Army", variant: "Newkama Queen", type: "Support", atk: 140, hp: 1250, speed: 88, basePower: 1850, weapon: "None", devilFruit: "Horu Horu no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 180, code: "karasu", name: "Karasu", title: "North Army Commander", rarity: "S", arc: "Final Saga", faction: "Revolutionary Army", variant: "Crow Swarm", type: "Control", atk: 190, hp: 1380, speed: 94, basePower: 2150, weapon: "None", devilFruit: "Susu Susu no Mi", equipType: "Devil Fruit", image: "" }),
  boostCard({ id: 181, code: "belo_betty", name: "Belo Betty", title: "East Army Commander", rarity: "S", arc: "Final Saga", faction: "Revolutionary Army", variant: "Encouragement Support", boostType: "hp", boostValue: 8, boostTarget: "team", basePower: 1800, boostDescription: "Increase team HP by 10% passively.", devilFruit: "Kobu Kobu no Mi", equipType: "Devil Fruit", image: "" }),
  boostCard({ id: 182, code: "inazuma", name: "Inazuma", title: "Revolutionary Scissorhands", rarity: "A", arc: "Impel Down", faction: "Revolutionary Army", variant: "Scissor Support", boostType: "hp", boostValue: 6, boostTarget: "team", basePower: 1450, boostDescription: "Increase team HP by 8% passively.", devilFruit: "Choki Choki no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 183, code: "jewelry_bonney", name: "Jewelry Bonney", title: "Big Eater", rarity: "A", arc: "Egghead", faction: "Bonney Pirates", variant: "Age Distortion", type: "Control", atk: 160, hp: 1240, speed: 80, basePower: 1850, weapon: "None", devilFruit: "Toshi Toshi no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 184, code: "figarland_shamrock", name: "Figarland Shamrock", title: "Holy Knight", rarity: "S", arc: "Elbaf", faction: "Holy Knights", variant: "Twin Blade Authority", type: "Attacker", atk: 260, hp: 1580, speed: 89, basePower: 2420, weapon: "Cerberus", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 185, code: "jesus_burgess", name: "Jesus Burgess", title: "Champion", rarity: "S", arc: "Final Saga", faction: "Blackbeard Pirates", variant: "Strong-Strong", type: "Bruiser", atk: 205, hp: 1360, speed: 70, basePower: 2050, weapon: "None", devilFruit: "Riki Riki no Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 186, code: "catarina_devon", name: "Catarina Devon", title: "Crescent Moon Hunter", rarity: "S", arc: "Final Saga", faction: "Blackbeard Pirates", variant: "Nine-Tailed Fox", type: "Assassin", atk: 210, hp: 1280, speed: 87, basePower: 2300, weapon: "None", devilFruit: "Inu Inu no Mi, Model: Kyubi no Kitsune", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 187, code: "scopper_gaban", name: "Scopper Gaban", title: "Roger Pirates Left Hand", rarity: "S", arc: "Flashback", faction: "Roger Pirates", variant: "Twin Axe Legend", type: "Legend", atk: 258, hp: 1490, speed: 90, basePower: 2455, weapon: "Twin Axes", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 188, code: "chew", name: "Chew", title: "Fish-Man Sniper", rarity: "C", arc: "East Blue", faction: "Arlong Pirates", variant: "Water Shot", type: "Ranged", atk: 105, hp: 620, speed: 58, basePower: 860, weapon: "Water Bullets", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 189, code: "kuroobi", name: "Kuroobi", title: "Fish-Man Karate Officer", rarity: "B", arc: "East Blue", faction: "Arlong Pirates", variant: "Fish-Man Karate", type: "Bruiser", atk: 106, hp: 860, speed: 54, basePower: 1250, weapon: "Fish Karate", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 190, code: "dogra", name: "Dogra", title: "Gray Terminal Bandit", rarity: "C", arc: "Post-War", faction: "Dadan Family", variant: "Mountain Bandit", type: "Bruiser", atk: 100, hp: 640, speed: 50, basePower: 820, weapon: "Bandit Club", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 191, code: "magra", name: "Magra", title: "Gray Terminal Bandit", rarity: "C", arc: "Post-War", faction: "Dadan Family", variant: "Mountain Bandit", type: "Support", atk: 100, hp: 620, speed: 54, basePower: 820, weapon: "Bandit Knife", devilFruit: "None", equipType: "Weapon", image: "" }),
  ...
  battleCard({ id: 195, code: "harald", name: "Harald", title: "King of Elbaf", rarity: "S", arc: "Elbaf", faction: "Elbaf", variant: "Giant King", type: "Tank", atk: 259, hp: 1900, speed: 72, basePower: 2535, weapon: "Excalibur", devilFruit: "None", equipType: "Weapon", image: "" }),
  battleCard({ id: 196, code: "uta_diva", name: "Uta", title: "World Diva", rarity: "S", arc: "Film Red", faction: "Red Hair Pirates", variant: "New Genesis", type: "Control", atk: 240, hp: 1380, speed: 92, basePower: 2350, weapon: "Knight Form", devilFruit: "Uta Uta no Mi", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 200, code: "momonosuke_shogun", name: "Kozuki Momonosuke", title: "Shogun of Wano", rarity: "S", arc: "Wano", faction: "Kozuki Clan", variant: "Adult Dragon", type: "Bruiser", atk: 215, hp: 1580, speed: 72, basePower: 2360, weapon: "Ame no Habakiri", devilFruit: "Uo Replica", equipType: "Devil Fruit", image: "" }),
  ...
  battleCard({ id: 205, code: "killingham", name: "Saint Rimoshifu Killingham", title: "Warrior God of War", rarity: "S", arc: "Egghead", faction: "World Government", variant: "Demonic Form", type: "Legend", atk: 247, hp: 1450, speed: 88.5, basePower: 2480, weapon: "Leister", devilFruit: "Ryu Ryu no Mi, Model: Kirin", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 206, code: "sommers", name: "Saint Shepherd Sommers", title: "Warrior God of Order", rarity: "S", arc: "Egghead", faction: "World Government", variant: "Demonic Form", type: "Legend", atk: 247, hp: 1450, speed: 88.5, basePower: 2480, weapon: "Tetsubo", devilFruit: "Iba Iba No Mi", equipType: "Devil Fruit", image: "" }),
  battleCard({ id: 207, code: "wgs", name: "World Government Sovereigns", title: "World Government Sovereigns", rarity: "M", baseTier: "M", pullTier: "MERGE", canPull: false, canPA: false, summonOnly: true, mergeOnly: true, mergeSourceCodes: ["imu", "killingham", "sommers"], mergeStatRatio: 0.36, arc: "Final Saga", faction: "World Government", variant: "Imu, Killingham & Sommers", type: "Merge", atk: 0, hp: 0, speed: 0, basePower: 0, weapon: "None", devilFruit: "None", equipType: "Devil Fruit / Weapon", image: "" }),
  battleCard({ id: 208, code: "ya", name: "Yonko Alliance", title: "Yonko Alliance", rarity: "M", baseTier: "M", pullTier: "MERGE", canPull: false, canPA: false, summonOnly: true, mergeOnly: true, mergeSourceCodes: ["kaido_strongest_creature", "big_mom_emperor"], arc: "Wano", faction: "Emperors", variant: "Kaido & Big Mom", type: "Merge", atk: 0, hp: 0, speed: 0, basePower: 0, weapon: "None", devilFruit: "None", equipType: "Devil Fruit / Weapon", image: "" }),
  battleCard({ id: 209, code: "gvc", name: "God Valley Curse", title: "God Valley Curse", rarity: "M", baseTier: "M", pullTier: "MERGE", canPull: false, canPA: false, summonOnly: true, mergeOnly: true, mergeSourceCodes: ["xebec_captain_of_rocks", "blackbeard_emperor_of_darkness"], arc: "Final Saga", faction: "Rocks / Blackbeard Pirates", variant: "Xebec & Teach", type: "Merge", atk: 0, hp: 0, speed: 0, basePower: 0, weapon: "None", devilFruit: "None", equipType: "Devil Fruit / Weapon", image: "" }),
  battleCard({ id: 210, code: "dk", name: "Divine Knights", title: "Divine Knights", rarity: "M", baseTier: "M", pullTier: "MERGE", canPull: false, canPA: false, summonOnly: true, mergeOnly: true, mergeSourceCodes: ["figarland_shamrock", "gunko_holy_knight"], arc: "Elbaf", faction: "Holy Knights", variant: "Shamrock & Gunko", type: "Merge", atk: 0, hp: 0, speed: 0, basePower: 0, weapon: "None", devilFruit: "None", equipType: "Devil Fruit / Weapon", image: "" }),
...
const SPECIAL_FORMS = {
  ...
  buggy_the_clown: ["Early Buggy", "Alabasta", "Impel Down Yonko"],
  ...
  kaku_cp9: ["Rokushiki Master", "CP9 Assassin", "Giraffe Awakening"],
  brook_soul_king: ["Soul Solid", "Soul Parade", "Soul King"],
  gecko_moria: ["Shadow Master", "Thriller Bark Ruler", "Shichibukai Tyrant"],
  ...
  akainu: ["Marineford", "Magma Emperor", "Absolute Justice"],
  aokiji: ["Marineford", "Ice Age", "Frozen Admiral"],
  kizaru: ["Marineford", "Light-Speed Assault", "Photon Admiral"],
  ...
  killingham: ["War Warrior God", "Demonic Form", "Fenrir Terror"],
  sommers: ["Order Warrior God", "Demonic Form", "Divine Terror"],
  ...
  jack_the_drought: ["Jack the Drought", "Ancient Zoan Power", "Beast Pirates Lead Performer"],
  yamato_oni_princess: ["Oni Princess", "Oden's Will", "Guardian Wolf"],
  ...
  mr2: ["Mane Mane Master", "Okama Performer", "Copycat Dancer"],
  higuma: ["Mountain Bandit", "Bear Slayer", "Forest Outlaw"],
  x_drake: ["Ancient Predator", "SWORD Captain", "Allosaurus Hunter"],
  scratchmen_apoo: ["Sound Assassin", "Rhythm Destroyer", "On-Air Menace"],
  charlotte_daifuku: ["Genie Summoner", "Lamp Commander", "Smoky Executioner"],
  charlotte_oven: ["Heat Tyrant", "Boiling Fist", "Burning Minister"],
  charlotte_brulee: ["Mirror Witch", "Reflection Keeper", "World Between Glass"],
  basil_hawkins: ["Straw Fortune", "Voodoo Prophet", "Fate Manipulator"],
  capone_bege: ["Castle Fortress", "Mafia Don", "Big Father"],
  neptune: ["Sea King", "Ryugu Monarch", "Trident Sovereign"],
  dorry: ["Giant Warrior", "Elbaf Champion", "Hakoku Vanguard"],
  brogy: ["Giant Berserker", "Elbaf Guardian", "Hakoku Crusher"],
  emporio_ivankov: ["Hormone Master", "Okama Queen", "Revolution Miracle"],
  karasu: ["Soot Commander", "Crow Legion", "Shadow Revolutionary"],
  belo_betty: ["Freedom Herald", "Morale Booster", "Revolution Standard"],
  inazuma: ["Scissor Human", "Path Cutter", "Revolution Architect"],
  jewelry_bonney: ["Age Manipulator", "Gluttonous Rogue", "Future Distortion"],
  figarland_shamrock: ["Holy Knight Leader", "Celestial Executioner", "Divine Authority"],
  jesus_burgess: ["Champion Wrestler", "Titanic Helmsman", "Brutal Powerhouse"],
  catarina_devon: ["Crescent Huntress", "Nine-Tailed Fox", "Identity Thief"],
  scopper_gaban: ["Roger's Left Hand", "Axe Master", "Pirate Legend"],
  chew: ["Water Shoot", "Fishman Gunner", "Aqua Marksman"],
