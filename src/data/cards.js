...
const SPECIAL_FORMS = {
  ...
  jango_hypnotist: ["Syrup Village", "Jango Dance Paradise", "Marine Phase (Hina Unit)"],
  ...
  bepo_navigator_support: ["Sabaodyhipelago", "Heart Pirates", "Final War"],
  killer_massacre_soldier: ["Sabaodyhipelago", "Wano Country", "Rooftop War"],
  marco_phoenix: ["Marineford", "Wano Country", "Whitebeard Remnants"],
  ben_beckman: ["Romance Dawn", "Post-Enies Lobby", "Egghead"],
  charlotte_pudding: ["Whole Cake Island", "Whole Cake Island", "Whole Cake Island"],
  ...
  perona_ghost_princess: ["Thriller Bark", "Sabaodyhipelago", "Hawk Pirates"],
  tsuru_tactical_support: ["Sengoku Era", "Marineford", "Marine HQ"],
  reiju_poison_pink: ["Germa Kingdom", "Whole Cake Island", "Whole Cake Island Support"],
